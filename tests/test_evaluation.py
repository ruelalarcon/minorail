...
from runner.observers import GameEndedEvent, GameStartedEvent, PieceLockedEvent
...
class EvaluationCollectorTests(unittest.TestCase):
    def test_collector_records_events_and_summary_rollups(self) -> None:
        ...
        self.assertEqual(result["summary"]["combo_total"], 3)
        self.assertEqual(result["summary"]["back_to_back_steps"], 1)
        self.assertEqual(result["summary"]["back_to_back_total"], 6)
